<template>
  <el-card>
    <el-button type="primary" plain size="small" @click="addMschoolInfo" class="addBtn">添加学校管理员</el-button>
    <el-table :data="mschoolTable" border :height="tableHeight" v-loading="loading">
    ...
    <el-dialog :visible.sync="showAddMschoolDialog" title="添加学校管理员" width="30%">
      ...
      <span slot="footer" class="dialog-footer">
        <el-button @click="showAddMschoolDialog = false">取 消</el-button>
